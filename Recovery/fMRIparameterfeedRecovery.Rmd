...
ggsave("/Volumes/Research Project/Social Evaluative Feedback fMRI/corrHeatMaps.png", units = "in", dpi = 600, width = 10, height = 4)
ggsave("/Volumes/Research Project/Social Evaluative Feedback fMRI/corrHeatMaps.tiff", units = "in", dpi = 600, width = 10, height = 4)
```
